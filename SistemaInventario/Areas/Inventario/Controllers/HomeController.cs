    ...
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Index(int pageNumber = 1, string busqueda="", string busquedaActual="")
        {
            ...
            Parametros parametros = new Parametros()
            {
                ...
                PageSize = 8 // Es la cantidad de registros que se muestran en la paginación, se puede modificar para que sean más
            };
        ...
        {
            var claimIdentity = (ClaimsIdentity)User.Identity;
            var claim = claimIdentity.FindFirst(ClaimTypes.NameIdentifier); // De esta menera se captura al usuario que está en ese momento logueado
